...
export class CollectionsService {
    /**
     * List collections
     * Returns a paginated list of collections, optionally filtered by name (q). Ordered by created_at DESC.
    ...
    /**
     * Create collection
     * Create a new collection with name, optional description, and optional filter definition.
     * @param requestBody
    ...
    /**
     * Update collection
     * Partially update a collection by UUID.
     * @param id
     * @param requestBody
     * @returns CollectionDto_Output
     * @throws ApiError
     ...
     * Returns documents that match the collection filters with pagination (ordered by scraped_at DESC).
     * @param id
