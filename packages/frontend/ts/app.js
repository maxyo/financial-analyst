...
var AnalyticsPanel_1 = require("./components/AI/AnalyticsPanel");
...
function App() {
    ...
    return (<styles_1.ThemeProvider theme={theme}>
      ...
      <material_1.Container maxWidth="lg" sx={{ mt: 2, mb: 4 }}>
        {route === 'jobs' ? (<JobsList_1.JobsList />) : route === 'sources' ? (<SourcesPanel_1.SourcesPanel />) : (<>
            ...
            {activeTab === 'overview' ? (<material_1.Grid container spacing={2}>
                <material_1.Grid size={{ xs: 12, md: 6 }}>
                  <InstrumentSummary_1.InstrumentSummary summary={summary}/>
                </material_1.Grid>

                {underlying && (<material_1.Grid size={{ xs: 12, md: 6 }}>
              ...
              </material_1.Grid>) : (<AnalyticsPanel_1.AnalyticsPanel defaultInstrument={ticker}/>)}
          </>)}
